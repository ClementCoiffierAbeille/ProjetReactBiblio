  ...
  return (
    <div className="home">
      ...
      <div className='evenements'>
        <div className='event'>
          <h2>Évenements : </h2>
          <p>Découvrez les temps forts culturels à la Médiathèque de Talence ce mois-ci !<br/>
          ...
          Du 10 au 25 février.
          <br/>Rencontre Littéraire avec l'auteur local Marie Dubois : Rejoignez-nous pour une discussion animée avec l'écrivaine Marie Dubois autour de son dernier roman acclamé par la critique.<br/>           
        ...
        {bookdata && bookdata.length > 0 ? (
          <div className='nouveauteslivres'>
            {bookdata.map((book, index) => (
              <img key={index} className='book' src={book.thumbnail} alt='book' />
            ))}
          </div>
        ) : (
